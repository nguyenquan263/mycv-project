<script>
	...
	// 	fetch('https://sveltejs-course-default-rtdb.firebaseio.com/hobbies.json')
	// 	.then((res) => {
	// 		if(!res.ok) {
	...
	let getHobbies = fetch('https://sveltejs-course-default-rtdb.firebaseio.com/hobbies.json')
		.then((res) => {
			if(!res.ok) {
				throw new Error('Failed!');
			}
